...
| Файл | Описание |
|----|----|
| `capybara_nightmare.png` | Изображение для анализа |
...
1. Флаг зашифрован XOR
2. Ключ спрятан в изображении
3. Используется LSB стеганография
4. Длина пароля: 19 символов
...
| `binwalk` | Анализ и извлечение встроенных данных |
| `unzip` | Распаковка ZIP архива |
| Python + PIL | Извлечение LSB |
| Python | XOR расшифровка |
...
1. **Polyglot-файл** — не все инструменты автоматически обнаруживают
2. **Кастомный маркер LSB** — `END_LSB` вместо стандартных маркеров
3. **XOR шифрование** — требует найти ключ, простой brute-force невозможен без знания длины и формата ключа

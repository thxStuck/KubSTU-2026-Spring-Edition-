...
Формат флага: KubSTU{…}.
 Укажите, с помощью какой уязвимости был получен первоначальный доступ и что он загрузил?От имени какого пользователя далее действовал злоумышленник?Что скопировал?Пример: KubSTU{XSS,p0wny.php,Administrator,data.txt}
Решение:

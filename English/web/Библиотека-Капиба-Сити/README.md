...
Let's try to read the file `flag.txt`, located in the application directory: 


### Payload

We modify the request by adding an entity definition `&xxe;` that references the file `flag.txt`:
